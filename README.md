...
####  به کمک این ماژول می‌توانید تاریخچه قیمت‌های موجود در سایت اطلاع‌رسانی طلا، سکه و ارز را دریافت کنید که شامل اطلاعات 250 دارایی متفاوت از جمله طلا،   سکه، ارز، برخی کالاهای جهانی و مهمترین رمز ارزها است که ازجمله ویژگی‌های مهم این ماژول می‌توان به موارد زیر اشاره کرد:
